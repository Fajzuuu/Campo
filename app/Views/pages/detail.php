...
<style>
    ...
    /* Footer */
    .footer-custom { background-color: #70bdeb; color: white; padding: 20px 0; margin-top: 50px; font-size: 0.9rem; }
    .footer-custom a { color: white; text-decoration: none; margin: 0 10px; }
    .footer-custom .social-icons i { font-size: 1.2rem; margin-left: 15px; cursor: pointer; }
</style>
...
<div class="container mt-4 mb-5">
    ...
    <div class="row">
        <div class="col-lg-8 pe-lg-4">
            ...
            <p class="text-muted"><i class="bi bi-geo-alt"></i> Semaki, Umbulharjo, Yogyakarta</p>
            <hr>
...
<footer class="footer-custom">
    <div class="container d-flex flex-column flex-md-row justify-content-between align-items-center">
        <div class="mb-3 mb-md-0">
            &copy; 2023 Field All Right Reserved
            <a href="#">Privacy Policy</a>
            <a href="#">Legal</a>
        </div>
        <div class="d-flex align-items-center">
            <span>support@field.id</span>
